...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Mapping Visibility'), ['action' => 'edit', $mappingVisibility->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Mapping Visibility'), ['action' => 'delete', $mappingVisibility->id], ['confirm' => __('Are you sure you want to delete # {0}?', $mappingVisibility->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Mapping Visibilities'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Mapping Visibility'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="mappingVisibilities view content">
            <h3><?= h($mappingVisibility->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($mappingVisibility->profiles)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($mappingVisibility->profiles as $profiles) : ?>
                        <tr>
                            <td><?= h($profiles->id) ?></td>
