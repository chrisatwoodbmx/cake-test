...
class OrganisationsController extends AppController
{
    ...
    public function view($id = null)
    {
        $organisation = $this->Organisations->get($id, [
            'contain' => ['ParentOrganisations', 'MappingOrganisations', 'ChildOrganisations'],
        ]);
    ...
    public function add()
    {
        ...
        $parentOrganisations = $this->Organisations->ParentOrganisations->find('list', ['limit' => 200])->all();
        $this->set(compact('organisation', 'parentOrganisations'));
    }
