...
class ContentsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Profiles', 'CustomTabTitles'],
        ];
    ...
    public function add()
    {
        ...
        $profiles = $this->Contents->Profiles->find('list', ['limit' => 200])->all();
        $customTabTitles = $this->Contents->CustomTabTitles->find('list', ['limit' => 200])->all();
        $this->set(compact('content', 'profiles', 'customTabTitles'));
    }
